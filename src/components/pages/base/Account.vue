...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            tableData() {
                var list = _.map(this.resData.data.list,item=>{return {...item, id: item[this.code+'_guid']}})
        ...
        methods: {
            async dataReload() {
                ...
                try{
                     var mainRes = await this.api.account("master","getList")
